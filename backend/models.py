...
class ActiveEffect:
    def __init__(self, effect_type, value, duration_seconds, started_at=None):
        self.effect_type = effect_type  # 'damage', 'hp', 'luck'
        self.value = value
        self.duration_seconds = duration_seconds
        self.started_at = started_at or datetime.now()
    
    def is_active(self):
        return (datetime.now() - self.started_at).total_seconds() < self.duration_seconds
